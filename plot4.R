...
# Upper right chart
plot(time_col, pwrd_2d$Voltage, type='l', ylab="Voltage", xlab="datetime")

# Lower right chart
plot(time_col, pwrd_2d$Global_reactive_power, type='l', ylab="Global_reactive_power", xlab="datetime")
